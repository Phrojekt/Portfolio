...
export function HeroSection () {
  return(
    <div className="flex flex-1 flex-col justify-center items-center w-screen bg-custom-gradient h-full" style={{
      background:
        ...
        <div className="mt-[16px] flex justify-around gap-8">
          <Link href="#" className="flex flex-1 items-center justify-start gap-2 rounded-md bg-green w-[185px] h-[40px] p-[10px]"> 
